...
class ViewController: UIViewController {
    ...
    @IBAction func randomButton(_ sender: UIButton) {
        if waitingInProgress == 0 {
            n = Int(arc4random_uniform(UInt32(words.count)))
            remainingTime = 10
            waitingInProgress = 1
            ...
            for (wLabel, wDef) in randomWord {
                wordLabel.text = wLabel
                wordDef = wDef
            }
...
//                wordDef = "Murdering, killing a lot of people"
//            }
//            else if n == 3 {
...
//                wordDef = "being able to withstand something & recover quickly"
//            }
//            else if n == 13 {
